...
import {mapStateToProps, matchDispatcherToProps,} from "./sn.left-menu.container";
			...
			<div style={{marginTop:76}}>
				<List className="left-menu-list-root">
					<ListItem className="appstore-mobile-link hidden-sm-up">
						<ListItemText>
							<Link rel="noopener noreferrer" target="_blank" href="https://blog.sia.tech/own-your-space-eae33a2dbbbc"
